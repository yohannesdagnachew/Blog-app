  ...
  describe 'GET /users/index' do
    before(:each) do
      @user_1 = User.create(name: 'John', # rubocop:todo Naming/VariableNumber
                            ...
                            photo: 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8dXNlcnxlbnwwfHwwfHw%3D&w=1000&q=80', bio: 'John is a great person.')
